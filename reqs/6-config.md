...
| `rooms_dir` | String | `.rooms` | Directory for storing room worktrees |
...
# Directory for room worktrees (relative to repo root)
rooms_dir = ".rooms"
...
- Missing file uses defaults (no base branch, `.rooms` directory, no post-create commands)
